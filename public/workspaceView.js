(function attachWorkspaceView(root, factory) {
  ...
  const NL_MESSAGES = Object.freeze({
    ...
    'Session ended': 'Sessie beeindigd',
    ...
    'Browser session storage could not be updated. The rejected session no longer grants API access.': 'De sessieopslag van de browser kon niet worden bijgewerkt. De afgewezen sessie geeft geen API-toegang meer.',
    'This session has ended. Use a new invitation or explicitly choose local access.': 'Deze sessie is beeindigd. Gebruik een nieuwe uitnodiging of kies expliciet voor lokale toegang.',
    'The session changed while this request was pending. Check workspace history before retrying changes.': 'De sessie is gewijzigd tijdens dit verzoek. Controleer de geschiedenis van de werkruimte voordat je wijzigingen opnieuw probeert.',
