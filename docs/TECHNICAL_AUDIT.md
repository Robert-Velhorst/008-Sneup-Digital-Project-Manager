...
| Accessibility/i18n | Partial | English/Dutch shell, setup, help, command-palette, primary workflow, and connector-marketplace catalogs pass accessible-name and responsive browser checks. Complete approval/workspace dynamic copy and an assistive-technology review before claiming conformance. |
