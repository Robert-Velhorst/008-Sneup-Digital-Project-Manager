...
2.3.74 closes notification-policy UI ownership gaps. Policy save/edit, activation, explicitly confirmed test delivery, and inline pause flows now reject stale submissions and suppress late notices/closures after workspace, session, modal, or row ownership changes. Eight new cases cover the previously reproduced failures. The backend approval and authorization boundaries are unchanged; other detail/forms and cross-device coordination remain open.
