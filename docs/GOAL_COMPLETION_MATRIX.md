...
| 046 Cross-user isolation | Partial | Backend workspace identity and authorization regression coverage; administration/report downloads, ten primary dashboard GET readers, shared selector refresh, and three forecast forms guarded. Other open forms, detail reads, and invitation/session transitions still need full context-transition verification. |
