...
| 046 Cross-user isolation | Partial | Backend workspace identity and authorization regression coverage; administration/report downloads, ten primary dashboard GET readers, shared selector refresh, three forecast forms, invitation acceptance, and deletion completion guarded. Other open forms, detail reads, session revocation, and interrupted-onboarding recovery still need full context-transition verification. |
