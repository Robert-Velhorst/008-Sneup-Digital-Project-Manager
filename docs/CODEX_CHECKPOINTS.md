...
| Full regression | 84 suites/686 tests, lint, 5/5 evaluation, and two zero-vulnerability dependency audits | Complete |
...
| Windows package | 2.3.3 NSIS build, installer window, demo and fail-closed live startup, native ngrok binding, metadata, and SHA-256 | Complete, unsigned |
| Fresh clone | 2.3.3 Node 24 quality and Windows installer jobs | Pending exact GitHub run |
...
| GitHub CI | Local 2.3.3 release gates pass; exact quality and installer artifact run | Pending push |
