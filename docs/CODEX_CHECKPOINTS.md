...
| Full regression | 104 suites/793 tests, lint, 5/5 evaluation, two zero-vulnerability dependency audits, and positive five-secret release verification | Complete |
...
| Windows package | 2.3.15 NSIS build, demo diagnostics/HAI smoke, metadata, SHA-256, repeatable resource sample, and clean close | Complete locally; publisher signing external |
| Fresh clone | 2.3.15 exact source `2fa0a91691c74dc68c552e56f6ce08227fbbe826`; Node 24 quality and Windows installer jobs in run `31316707100` | Complete |
...
| GitHub CI | 2.3.15 run `31316707100` passed both jobs; artifact `9038991309` was downloaded and independently checked | Complete |
