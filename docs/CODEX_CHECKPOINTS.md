...
| Full regression | 109 suites/817 tests, lint, 5/5 evaluation, two zero-vulnerability dependency audits, and positive five-secret release verification | Complete |
...
| Windows package | 2.3.19 NSIS build, demo diagnostics/HAI smoke, metadata, SHA-256, repeatable resource sample, and clean close | Complete locally; publisher signing external |
