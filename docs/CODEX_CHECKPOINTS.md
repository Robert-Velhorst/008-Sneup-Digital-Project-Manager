...
| Full regression | 93 suites/732 tests, lint, 5/5 evaluation, two zero-vulnerability dependency audits, and positive five-secret release verification | Complete |
...
| Windows package | 2.3.8 NSIS build, demo/Adobe/HAI smoke, native ngrok binding, metadata, SHA-256, resource sample, and clean close | Complete locally; publisher signing external |
| Fresh clone | 2.3.8 exact source `988f9a8f3abed7ec39b2b5718d5a67d8479c6f37`; Node 24 quality and Windows installer jobs in run `31307217856` | Complete |
...
| GitHub CI | Run `31307217856` passed both zero-annotation jobs; artifact `9036334669` downloaded and independently checked | Complete |
