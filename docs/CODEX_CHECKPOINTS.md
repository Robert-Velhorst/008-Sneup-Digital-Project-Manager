...
| Full regression | 91 suites/721 tests, lint, 5/5 evaluation, two zero-vulnerability dependency audits, and positive five-secret release verification | Complete |
...
| Windows package | 2.3.7 NSIS build, demo smoke, native ngrok binding, metadata, SHA-256, resource sample, and clean close | Complete locally; publisher signing external |
| Fresh clone | 2.3.7 exact source `fd2bc329d9c07e232a742c6176e8e65ed8494c49`; Node 24 quality and Windows installer jobs in run `31305480486` | Complete |
...
| GitHub CI | Run `31305480486` passed both zero-annotation jobs; artifact `9035818760` downloaded and independently checked | Complete |
