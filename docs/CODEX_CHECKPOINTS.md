...
| Fresh clone | 2.3.32 exact source `8344df95e8f799c96cee5d0249ff3e48296b29c4`; Node 24 quality and Windows installer/runtime jobs in run `31760069838` | Complete |
...
| GitHub CI | 2.3.32 run `31760069838` passed both jobs, including packaged-app launch; artifact `9204287831` was downloaded and independently checked | Complete |
