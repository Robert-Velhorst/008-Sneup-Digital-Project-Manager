...
| Full regression | 108 suites/809 tests, lint, 5/5 evaluation, two zero-vulnerability dependency audits, and positive five-secret release verification | Complete |
...
| Windows package | 2.3.18 NSIS build, demo diagnostics/HAI smoke, metadata, SHA-256, repeatable resource sample, and clean close | Complete locally; publisher signing external |
| Fresh clone | 2.3.18 exact source `e0a0cbbc17c33a47bdbd12adbfe3991d07ffce07`; Node 24 quality and Windows installer jobs in run `31321936184` | Complete |
| Browser and Windows UI | Demand-loaded English/Dutch connector and workspace renderers, provider/user/evidence preservation, shared asset-version reuse, refresh, and desktop/480x844 containment passed in the in-app Browser with zero current console errors | Complete for these flows; screen-reader/clean-VM evidence pending |
...
| GitHub CI | 2.3.18 run `31321936184` passed both jobs; artifact `9040446117` was downloaded and independently checked | Complete |
