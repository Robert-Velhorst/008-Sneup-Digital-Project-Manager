...
| Full regression | 94 suites/738 tests, lint, 5/5 evaluation, two zero-vulnerability dependency audits, and positive five-secret release verification | Complete |
...
| Windows package | 2.3.9 NSIS build, demo/HAI/Trello-catalog smoke, metadata, SHA-256, resource sample, installer cancellation, and clean close | Complete locally; publisher signing external |
| Fresh clone | 2.3.9 exact source `8a430c30ecfb1cd5cda729a5fb0689d508b8e1df`; Node 24 quality and Windows installer jobs in run `31308308438` | Complete |
...
| GitHub CI | Run `31308308438` passed both zero-annotation jobs; artifact `9036645854` downloaded and independently checked | Complete |
