...
| A14 | CI and installer | `.github/workflows/ci.yml` | Green GitHub run and installer artifact | Pass for 2.3.34 source `05839483c1df250ea6acb0d265ce0e9b55510e03`, run `31763249069`, independently checked artifact `9205413905` |
