...
| A14 | CI and installer | `.github/workflows/ci.yml` | Green GitHub run and installer artifact | Pass for 2.3.35; 2.3.36 local installer passed and fresh GitHub evidence is pending publication |
