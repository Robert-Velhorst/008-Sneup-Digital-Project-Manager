...
| A14 | CI and installer | `.github/workflows/ci.yml` | Green GitHub run and installer artifact | Pass: 2.3.32 source `8344df95e8f799c96cee5d0249ff3e48296b29c4`, run `31760069838`, independently checked artifact `9204287831` (`sneup-windows-installer-unsigned`) |
