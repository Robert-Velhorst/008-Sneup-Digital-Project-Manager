...
| A14 | CI and installer | `.github/workflows/ci.yml` | Green GitHub run and installer artifact | Pass for 2.3.33 source `ee83ea53bcf2a019a213cc5b71bd6b2631b5c264`, run `31761836528`, independently checked artifact `9204933068`; 2.3.34 publication pending |
