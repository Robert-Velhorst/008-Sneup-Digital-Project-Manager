...
- English/Dutch localization covers the shell, setup, command palette, contextual help, and primary mission-control workflow chrome. Secondary dynamic operator surfaces still require explicit catalog coverage; provider/user/audit evidence remains verbatim by design.
